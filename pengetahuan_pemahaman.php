	...
	<body>
      ...
      require_once "dbconfig.php";
        ...
        <?php
            include "koneksi.php";
						// ORDER BY RAND()
            $query    = mysqli_query($koneksi, "SELECT * FROM pengetahuan_pemahaman WHERE id > 30 ORDER BY RAND()");
                ...
                <?php
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=23");
                          ...
                          $query2  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=25");
                          ...
                          $query3  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=26");
                          ...
                          $query4  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=27");
                          ...
                          $query5  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=30");
                          ...
                          $query6  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=34");
                          ...
                          $query7  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=35");
                          $cek4    =mysqli_num_rows($query7);
                          ...
                          $query8  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=36");
                          ...
                          $query9  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=40");
                          ...
                          $query10  = mysqli_query($koneksi, "SELECT * FROM penalaran_umum WHERE id='$nomor' AND jawaban='$jawaban' and bobot=50");
                          $cek4    =mysqli_num_rows($query10);
                      ...
                      $hasil = 300 + $score1 + $score2 + $score3 + $score4 + $score5 + $score6 + $score7 + $score8 + $score9 + $score10; 
